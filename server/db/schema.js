...
async function initSchema() {
  if (db.USE_PG) {
    ...
    const curatedResources = [
      // ── Water Rangers — open community-science data source ───────────────
      { title: 'Water Rangers — Open Data Portal', description: 'Browse and download every water-quality reading logged by Water Rangers citizen scientists across Canada and beyond. Filter by location, date, and parameter. Free and open access.', type: 'dataset', category: 'Datasets', url: 'https://data.waterrangers.com/', featured: true },
      { title: 'Water Rangers — Live Monitoring Map', description: 'Visual map of every Water Rangers monitoring site (the same sites SOURCE Water plots on its Monitoring Map). Real community readings, plotted geographically.', type: 'link', category: 'Community Science', url: 'https://waterrangers.com/map/', featured: true },
      { title: 'Water Rangers — Supported Parameters & Test Kits', description: 'The Water Rangers supported-parameters reference: what each test measures (pH, dissolved oxygen, turbidity, conductivity, alkalinity, hardness, E. coli) and the reading range of each kit.', type: 'guide', category: 'Field Work', url: 'https://data.waterrangers.com/supported-parameters' },
      { title: 'Water Rangers — Learning Hub', description: 'Free training materials for community water monitors — sampling protocols, parameter interpretation, QA workflows, the same standards SOURCE Water uses.', type: 'guide', category: 'Data Literacy', url: 'https://waterrangers.com/' },
      { title: 'Water Rangers — Field Stories', description: 'Frontline stories, science explainers, and community updates from Water Rangers citizen scientists.', type: 'link', category: 'Community Science', url: 'https://waterrangers.com/' },
      { title: 'Water Rangers — About the Program', description: 'How Water Rangers empowers communities to protect water through citizen science, open data, and advocacy.', type: 'link', category: 'Community Science', url: 'https://waterrangers.com/about/faqs/' },
