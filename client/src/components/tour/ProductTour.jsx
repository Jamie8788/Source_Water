...
const STEPS = [
  ...
  { route: '/dashboard', target: 'dash-sites', title: 'Dashboard — what’s happening now',
    ...
    tip: 'Click any site to jump straight to it on the map.' },
  { route: '/dashboard', target: 'dash-livesite', interactive: true,
    ...
    body: 'Pin one station as your “live site” and its latest pH, dissolved oxygen, temperature and conductivity stay here, with a coloured bar showing where each sits against guideline ranges.',
  ...
  { route: '/dashboard', target: 'dash-picker', interactive: true, title: 'Dashboard — pick your site',
    body: 'Search any station and choose it. Your dashboard immediately switches to that site and remembers it on this device.',
  ...
  { route: '/ai-lab', target: 'ailab-tab-anomalies', title: 'Wet Lab · Anomaly Detection',
    body: 'The first view. It scans every reading and flags the ones that stand out from that site’s own normal range — the spikes and dips worth a second look. The number in the tab is how many it found.',
    tip: 'This is where outliers surface automatically.' },
  { route: '/ai-lab', target: 'ailab-tab-insights', interactive: true, title: 'Wet Lab · Insights (the big one)',
    body: 'The plain-English Site Story: a trust score out of 100, what changed since the last visit, whether the water is getting better or worse over time, the strongest links between measurements, and a short “what to investigate” list — all computed from the real readings, no AI guessing.',
    tip: 'Click “Insights” to open it.' },
  { route: '/ai-lab', target: 'ailab-tab-trends', title: 'Wet Lab · Trends',
    ...
    tip: 'Use this to spot a long slow change a single reading would hide.' },
  { route: '/ai-lab', target: 'ailab-tab-charts', title: 'Wet Lab · Charts',
    body: 'Full interactive charts for each measurement, with guideline bands drawn on so you can see exactly when a reading crossed a line.',
    tip: 'The visual detail behind the Trends summary.' },
  { route: '/ai-lab', target: 'ailab-tab-ai', title: 'Wet Lab · Research AI',
    body: 'Ask questions in plain language about THIS site specifically — “has phosphate risen since 2022?” — and it answers from that site’s own record.',
    tip: 'Site-specific answers, grounded in the data on screen.' },
  ...
  { route: '/quiz', target: 'quiz-filters', title: 'Quiz — narrowing it down',
    body: 'Filter by category to focus a topic, and by difficulty — Beginner, Intermediate, Advanced — to match your level. Quizzes can be timed, can shuffle questions, and some award a certificate when you pass.',
    tip: 'Pick a category, then a difficulty, and start one.' },
  ...
  { route: '/alerts', target: 'alerts-add', interactive: true, title: 'Alerts — create a watch',
    body: 'A watch is your own rule on a real station: pick a site (from the 9,400+ Water Rangers ones or your own), a parameter, a comparator and a limit — for example “pH below 6.5”. When the latest reading breaks it, an alert fires.',
    tip: 'Click “Add watch” to open the form.' },
  { route: '/alerts', target: 'alerts-watches', title: 'Alerts — your watches',
    ...
    tip: 'Try “Check now” once you have a watch set up.' },
  ...
  { route: '/social', target: 'social-tabs', title: 'Community — feed, DMs and leaderboard',
    ...
    tip: 'Switch between the tabs to filter the feed.' },
  {
