...
const STEPS = [
  ...
  { route: '/monitoring', target: 'map-result', title: 'Site Map — your matches',
    body: 'There’s your filter result — how many of the 9,485 stations match, with a chip for each active filter. The map now shows only those dots, coloured by water-body type and grouped into numbered circles until you zoom in.',
  ...
  { route: '/monitoring', target: '.leaflet-control-zoom', interactive: true, manualNext: true,
    ...
    body: 'Here are the zoom controls. Numbered circles are clusters — zoom in and they break apart into individual stations. You can also scroll on the map or double-click an area.',
  ...
  { route: '/alerts', target: 'alerts-add', interactive: true,
    ...
    body: 'A watch is your own rule on a real station. When the latest reading breaks it, an alert fires.',
  ...
  { route: '/alerts', target: 'alerts-form', interactive: true, manualNext: true,
    ...
    body: 'Four choices make a rule: the SITE (search the 9,400+ Water Rangers stations, or switch to your own adopted list), the PARAMETER to watch, the COMPARATOR (above / below) and your LIMIT — e.g. “pH below 6.5”. Severity sets how loudly it shouts.',
