...
function WatchesPanel({ watches, sites, options, onCreate, onDelete, onToggle, onCheck, checking, onToast, onSitesChanged }) {
  ...
  return (
    <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 14, padding: '16px 18px', marginBottom: 20 }}>
      ...
      {adding && (
        <div data-tour="alerts-form" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 8, padding: 12, marginBottom: 12, background: 'rgba(99,102,241,0.04)', border: '1px solid rgba(99,102,241,0.15)', borderRadius: 10 }}>
